    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 刊物管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column label="第一作者"></el-table-column>
                <el-table-column prop="name" label="所有作者"></el-table-column>
                <el-table-column prop="name" label="支持基金"></el-table-column>
